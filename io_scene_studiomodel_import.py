...
def read_smd_mesh(path):
    ...
    bpy.context.collection.objects.link(mesh_o)
...
def do_bones(smd_mesh, j_re, e_re, hier, init):
    ...
    bpy.context.collection.objects.link(arm_o)
    ...
    for i, n, p in hier:
        ...
        while p0 >= 0:
            ...
            p0 = hier[p0][2]
    bpy.ops.object.mode_set()
    smd_grp = arm_o.pose.bone_groups.new(name="smd")
